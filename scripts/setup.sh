...
while ! $end; do
  ask_yn use_default_keyfile "Do you want this setup script to generate a keyfile for you?"

  if $use_default_keyfile; then
    echo ""
    echo "===== WARNING ====="
    echo "The keyfile generated by this setup script is likely to be of VERY LOW quality"
    echo "due to the probable lack of entropy in the live CD environment"
    echo ""
    echo "It is HIGHLY recommended that you generate a keyfile of higher quality"
    echo "from other environment for use in this installation."
    echo "==================="
    echo ""
